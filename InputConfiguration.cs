...
namespace AssetStatusInfo
{
    ...
    public class InputConfiguration
    {
        ...
        protected InputConfiguration(Predicate<String>? Comparer, Type TypeOf, KeyValuePair<int?, bool> MinimumValue, KeyValuePair<int?, bool> MaximumValue, KeyValuePair<uint?, bool> Length, KeyValuePair<uint?, bool> MaximumLength, KeyValuePair<uint?, bool> MinimumLength, List<string>? CodeWords, bool ShowMessage)
        {
            _comparer = Comparer;
            _typeOf = TypeOf;
        ...
        public uint? length
        {
            get
            {
                return _length.Value ? _length.Key : null;
            }
        }
        public Type typeOf
            { get => _typeOf; }
